...
word_syllabifications = CSV.read("tagged-data.csv")
...
CSV.open('prefix_new_scores_42000.csv', 'w') do |csv_object|
...
CSV.open('suffix_new_scores_42000.csv', 'w') do |csv_object|
